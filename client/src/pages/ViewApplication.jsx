            ...
            <tbody>
                    ...
                    {viewApplicationsPageData.map((applicant,index)=>(
                        <tr key={index} className='text-gray-700'>
                            ...
                            <td className='px-4 py-2 border-b text max-sm:hidden'>{applicant.jobTitle}</td>
                            <td className='px-4 py-2 border-b text max-sm:hidden'>{applicant.location}</td>
                            ...
                            <td className='px-4 py-2 border-b relative'>
                                ...
                                <div className='z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow group-hover:block'>
                                    <button className='block w-full text-left px-4 p-2 text-blue-500 hover:bg-gray-100'>Accept</button>
                                    <button className='block w-full text-left px-4 p-2 text-red-500 hover:bg-gray-100'>Reject</button>
                                </div>
                                </div>
                            </td>
                        </tr>                
